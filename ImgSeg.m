function rLayer = ImgSeg(imds,i,path_out_seg)
%% Detecting a Embryo Using Image Segmentation
% One of required functions of CreateVideoEmbryoStagesSeg
%% Read image
rgbImg = readimage(imds,i);
...
% Smooth and fill
EmbryoMask = imclose(EmbryoMask, strel('disk', 110));%30-14_2
...
% GLCM stats
GLCM2 = graycomatrix(rLayer,'Offset',[2 0;0 2]);
