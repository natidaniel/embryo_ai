% manual fixed trees with 9 and 8 features
...
morp_list_y = {'area','ecce','corr','cshad','energ','smoot','imc','hpsf','time'};
morp_list_o = {'area','diam','peri','ecce','contr','cshad','round','time'};        
