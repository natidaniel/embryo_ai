% manual fixed trees with 19 and 7 features
treefiguresdir = 'C:\Nati\Embryos\4Yoni\Embryo Deep learning\plot_nati\trees\46reduced\';
clear vector_O vector_Y
tfig = 555; % only for tree figures
fig = 1; 
morp_list_y = {'area','diam','peri','ecce','corr','cshad','dissi','energ','entr','smoot','de','imc','idm','round','dws','hpsf','bpsf','hog','time'};
morp_list_o = {'area','diam','peri','ecce','contr','cshad','round','DWS','time'};        
